...
<form action = "<?=base_url();?>materials/add_news" method="post" enctype="multipart/form-data">
...
<p><br><input type = "submit" name = "add_button" value = "Добавить новость"></p>
